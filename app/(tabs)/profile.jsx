  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'black' }} edges={['top']}>
      ...
      <View className="flex-row items-center px-4 pt-2 pb-4">
        <TouchableOpacity onPress={() => router.push('/')} className="absolute left-4 z-10">
          <Image 
        ...
        <Text className="flex-1 text-center text-4xl font-bold text-white font-['questrial']">
      ...
      <View className="items-center mb-6">
        ...
        <View className="w-full px-6 relative">
          <Text className="text-white text-xl font-questrial text-center">Profile Name</Text>
          <TouchableOpacity 
        ...
        <View className="w-full px-6 space-y-3">
          <TouchableOpacity 
            className="w-full bg-[#1A1A1A] py-2 rounded-lg items-center flex-row justify-center"
          ...
          <TouchableOpacity 
            className="w-full bg-[#1A1A1A] py-2.5 rounded-lg items-center flex-row justify-center"
